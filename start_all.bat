...
start "AI CV Analyzer" cmd /k "cd ai-cv-analyzer && python -m uvicorn main:app --host 0.0.0.0 --port 8002 --reload"

echo 4. Starting AI Gateway — Hybrid Orchestrator (Python / Port 8001)...
start "AI Gateway" cmd /k "cd ai-hybrid-orchestrator && python -m uvicorn main_api:app --host 0.0.0.0 --port 8001 --reload"

...
- Section 9.9/9.10 layout status: 9.9 heading, security-control rows, and Table 58 caption appear on PDF page(s) [103]; 9.10 starts on PDF page(s) [103] after the Table 58 caption
...
- Generated PDF page count: 134; generated PDF link annotations: PDF contains 142 link annotations after export.

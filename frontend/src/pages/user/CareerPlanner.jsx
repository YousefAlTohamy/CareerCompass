  ...
  const milestones = [
    {
      id: 1,
      year: 'Current',
      role: 'Current role from CV',
      status: 'completed',
      requirements: ['Confirmed skills', 'Recent experience', 'Profile completeness']
    },
    {
      id: 2,
      year: 'Year 1-2',
      role: 'Target growth role',
      status: 'active',
      progress: 65,
      requirements: ['Close missing skill gaps', 'Build proof projects', 'Improve interview readiness', 'Apply to matched roles']
    },
    {
      id: 3,
      year: 'Year 3-5',
      role: 'Long-term leadership path',
      status: 'locked',
      requirements: ['Validated senior scope', 'Team leadership evidence', 'Architecture ownership', 'Market-aligned specialization']
    }
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium mt-1 max-w-xl">
              {t('career_planner.subtitle', 'Preview how a CV role, skill gaps, and market demand can become a career roadmap.')}
            </p>
          </div>
        </div>

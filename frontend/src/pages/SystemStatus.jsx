...
export default function SystemStatus() {
  const systems = [
    { name: 'API Services', status: 'Operational', uptime: '99.98%', icon: Server, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/10' },
    { name: 'AI Engine', status: 'Operational', uptime: '99.95%', icon: Cpu, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/10' },
    { name: 'Scraping Cluster', status: 'Operational', uptime: '98.2%', icon: Globe, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/10' },
    { name: 'Database Clusters', status: 'Operational', uptime: '100%', icon: Database, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/10' },
    { name: 'Real-time Analytics', status: 'Operational', uptime: '99.9%', icon: Activity, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/10' },
    { name: 'WebSockets Layer', status: 'Maintenance', uptime: '99.8%', icon: Zap, color: 'text-amber-500', bg: 'bg-amber-50 dark:bg-amber-900/10' }
  ];

  const incidents = [
    { date: 'Apr 05, 2026', title: 'Scheduled Maintenance: WebSockets Cluster 3', status: 'Completed', type: 'maintenance' },
    { date: 'Mar 28, 2026', title: 'Increased Latency: AI Resume Parsing', status: 'Resolved', type: 'incident' },
    { date: 'Mar 15, 2026', title: 'Minor Outage: Scraping Node EU-West', status: 'Resolved', type: 'incident' }
  ];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pt-24 pb-20 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-3 text-center md:text-left">
                ...
                <h1 className="text-3xl md:text-4xl font-black tracking-tight">All systems are operational</h1>
                <p className="text-emerald-50 font-medium">As of April 6, 2026 at 18:00 UTC</p>
              </div>
             ...
             >
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Uptime: {s.uptime}</p>
                   </div>
                </div>
        ...
        <div className="space-y-6">
           <h2 className="text-xl font-black text-slate-800 dark:text-white px-2 uppercase tracking-widest text-sm">Past Events (90 Days)</h2>
